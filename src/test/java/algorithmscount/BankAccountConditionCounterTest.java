...
public class BankAccountConditionCounterTest {
    ...
    public void testCountWithBalanceGreaterThan() {
        ...
        assertEquals(3, new BankAccountConditionCounter().countLarger(bankAccounts, 100));
        assertEquals(0, new BankAccountConditionCounter().countLarger(bankAccounts, 400));
    }
}
